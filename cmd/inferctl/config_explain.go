...
func configKeyCatalog() []inferctl.ConfigKeyDef {
	return []inferctl.ConfigKeyDef{
		...
		keyDef("backends.<name>.auth_header_name", "string|null", false, nil, "Header name for authenticated openai_compat backends.", nil, "Authorization"),
		keyDef("backends.<name>.auth_header_value", "string|null", false, nil, "Header value for authenticated openai_compat backends; redacted from diagnostics.", nil, "<set-by-user>"),
