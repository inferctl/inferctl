...
const (
	...
	ECredentialReferenceConflict                    = "E_CREDENTIAL_REFERENCE_CONFLICT"
	ECredentialReferenceEnvironmentEmpty            = "E_CREDENTIAL_REFERENCE_ENVIRONMENT_EMPTY"
	ECredentialReferenceEnvironmentMissing          = "E_CREDENTIAL_REFERENCE_ENVIRONMENT_MISSING"
	ECredentialReferenceEnvironmentVariableInvalid  = "E_CREDENTIAL_REFERENCE_ENVIRONMENT_VARIABLE_INVALID"
	ECredentialReferenceEnvironmentVariableRequired = "E_CREDENTIAL_REFERENCE_ENVIRONMENT_VARIABLE_REQUIRED"
	ECredentialReferenceHeaderNameRequired          = "E_CREDENTIAL_REFERENCE_HEADER_NAME_REQUIRED"
	ECredentialReferenceLiteralRequired             = "E_CREDENTIAL_REFERENCE_LITERAL_REQUIRED"
	ECredentialReferenceSourceFieldConflict         = "E_CREDENTIAL_REFERENCE_SOURCE_FIELD_CONFLICT"
	ECredentialReferenceSourceRequired              = "E_CREDENTIAL_REFERENCE_SOURCE_REQUIRED"
	ECredentialReferenceSourceUnsupported           = "E_CREDENTIAL_REFERENCE_SOURCE_UNSUPPORTED"
	ECredentialReferenceUnsupportedBackend          = "E_CREDENTIAL_REFERENCE_UNSUPPORTED_BACKEND"
